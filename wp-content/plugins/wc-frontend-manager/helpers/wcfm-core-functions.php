...
if(!function_exists('wcfm_woocommerce_version_notice')) {
	function wcfm_woocommerce_version_notice() {
		?>
		<div id="message" class="error">
		<p><?php printf( __( '%sOops ..!!!%s You are using %sWC %s. WCFM works only with %sWC 3.0+%s. PLease upgrade your WooCommerce version now to make your life easier and peaceful by using WCFM.', 'wc-frontend-manager' ), '<strong>', '</strong>', '<strong>', WC_VERSION . '</strong>', '<strong>', '</strong>' ); ?></p>
		</div>
		<?php
	}
}
							...
							if( $feature_only ) {
								...
								if( wcfm_is_vendor() ) {
									...
									if( $wcfm_membership && function_exists( 'wcfm_is_valid_membership' ) && wcfm_is_valid_membership( $wcfm_membership ) ) {
										// translators: 1) open <strong> tag 2) close </strong> tag 3) feature 4) membership title
										printf( __( '%1$s%3$s%2$s: Your %4$s membership level doesn\'t give you permission to access this page. Please upgrade your membership, or contact the %1$sWebsite Manager%2$s for assistance.', 'wc-frontend-manager' ), '<strong>', '</strong>', $feature, '<strong>' . get_the_title( $wcfm_membership ) . '</strong>');	
									} else {
										// translators: 1) open <strong> tag 2) close </strong> tag 3) feature
										printf( __( '%1$s%3$s%2$s: You don\'t have permission to access this page. Please contact your %1$sStore Admin%2$s for assistance.', 'wc-frontend-manager' ), '<strong>', '</strong>', $feature );
									}
								} else {
									// translators: 1) open <strong> tag 2) close </strong> tag 3) feature
									printf( __( '%1$s%3$s%2$s: You don\'t have permission to access this page. Please contact your %1$sStore Admin%2$s for assistance.', 'wc-frontend-manager' ), '<strong>', '</strong>', $feature );
		...
		if( wcfm_is_vendor() ) {
			if( !$only_admin ) {
				if( $text_only ) {
					...
					printf( __( '%s: Please ask your Store Admin to upgrade your dashboard to access this feature.', 'wc-frontend-manager' ), $feature );
				} else {
					?>
					<div id="wcfmu-feature-missing-message" class="wcfm-warn-message wcfm-wcfmu" style="display: block;">
						<p><span class="wcfmfa exclamation-triangle"></span><?php 
							// translators: 1) open <strong> tag 2) close </strong> tag 3) feature
							printf( __( '%1$s%2$s%3$s: Please ask your %1$sStore Admin%2$s to upgrade your dashboard to access this feature.', 'wc-frontend-manager' ), '<strong>', '</strong>', $feature ); 
						?></p>
					</div>
					<?php
				}
			...
			if( $text_only ) {
				// translators: 1) feature
				printf( __( '%s: Upgrade your WCFM to WCFM - Ultimate to avail this feature. Disable this notice from settings panel using "Disable Ultimate Notice" option.', 'wc-frontend-manager' ), $feature );
			} else {
				?>
				<div id="wcfmu-feature-missing-message" class="wcfm-warn-message wcfm-wcfmu" style="display: block;">
					<p><span class="wcfmfa exclamation-triangle"></span><?php 
						// translators: 1) open <strong> tag 2) feature 3) close </strong> tag 4) link start 5) link end
						printf( __( '%s%s%s: Upgrade your WCFM to %sWCFM - Ultimate%s to access this feature. Disable this notice from settings panel using "Disable Ultimate Notice" option.', 'wc-frontend-manager' ), '<strong>', $feature, '</strong>', '<a target="_blank" href="https://wclovers.com/product/woocommerce-frontend-manager-ultimate/?utm_source=wp-admin&utm_medium=banner&utm_campaign=promotion&utm_content=ultimate"><strong>', '</strong></a>' );
					?></p>
				</div>
				<?php
			}
...
if(!function_exists('wcfmgs_feature_help_text_show')) {
	function wcfmgs_feature_help_text_show( $feature, $only_admin = false, $text_only = false ) {
		...
		if( wcfm_is_vendor() ) {
			if( !$only_admin ) {
				if( $text_only ) {
					...
					<div id="wcfmu-feature-missing-message" class="wcfm-warn-message wcfm-wcfmu" style="display: block;">
						<p><span class="wcfmfa exclamation-triangle"></span><?php 
							// translators: 1) open <strong> tag 2) close </strong> tag 3) feature
							printf( __( '%1$s%3$s%2$s: Please ask your %1$sStore Admin%2$s to upgrade your dashboard to access this feature.', 'wc-frontend-manager' ), '<strong>', '</strong>', $feature ); 
						?></p>
					</div>
					<?php
				}
			...
			if( $text_only ) {
				// translators: 1) feature
				printf( __( '%s: Associate your WCFM with WCFM - Groups & Staffs to avail this feature.', 'wc-frontend-manager' ), $feature );
			} else {
				?>
				<div id="wcfmu-feature-missing-message" class="wcfm-warn-message wcfm-wcfmu" style="display: block;">
					<p><span class="wcfmfa exclamation-triangle"></span><?php 
						// translators: 1) open <strong> tag 2) feature 3) close </strong> tag 4) link start 5) link end
						printf( __( '%s%s%s: Associate your WCFM with %sWCFM - Groups & Staffs%s to access this feature.', 'wc-frontend-manager' ), '<strong>', $feature, '</strong>', '<a target="_blank" href="https://wclovers.com/product/woocommerce-frontend-manager-groups-staffs/?utm_source=wp-admin&utm_medium=banner&utm_campaign=promotion&utm_content=groups-staffs"><strong>', '</strong></a>' ); 
					?></p>
				</div>
				<?php
			}
	...
	function wcfma_feature_help_text_show( $feature, $only_admin = false, $text_only = false ) {
		...
		if( wcfm_is_vendor() ) {
			if( !$only_admin ) {
				if( $text_only ) {
					// translators: 1) feature
					printf( __( '%s: Please contact your Store Admin to access this feature.', 'wc-frontend-manager' ), $feature );
				} else {
					?>
					<div id="wcfmu-feature-missing-message" class="wcfm-warn-message wcfm-wcfmu" style="display: block;">
						<p><span class="wcfmfa exclamation-triangle"></span><?php 
							// translators: 1) open <strong> tag 2) close </strong> tag 3) feature
							printf( __( '%1$s%3$s%2$s: Please contact your %1$sStore Admin%2$s to access this feature.', 'wc-frontend-manager' ), '<strong>', '</strong>', $feature ); 
						?></p>
					</div>
					<?php
				}
			...
			if( $text_only ) {
				// translators: 1) feature
				printf( __( '%s: Associate your WCFM with WCFM - Analytics to access this feature.', 'wc-frontend-manager' ), $feature );
			} else {
				?>
				<div id="wcfmu-feature-missing-message" class="wcfm-warn-message wcfm-wcfmu" style="display: block;">
					<p><span class="wcfmfa exclamation-triangle"></span><?php 
						// translators: 1) open <strong> tag 2) feature 3) close </strong> tag 4) link start 5) link end
						printf( __( '%s%s%s: Associate your WCFM with %sWCFM - Analytics%s to access this feature.', 'wc-frontend-manager' ), '<strong>', $feature, '</strong>', '<a target="_blank" href="http://wclovers.com/product/woocommerce-frontend-manager-analytics/"><strong>', '</strong></a>' ); 
					?></p>
				</div>
				<?php
			}
...
if(!function_exists('get_wcfm_edit_product_url')) {
	function get_wcfm_edit_product_url( $product_id = '', $the_product = array(), $language_code = '' ) {
		...
		if ( defined( 'ICL_SITEPRESS_VERSION' ) && ! ICL_PLUGIN_INACTIVE && class_exists( 'SitePress' ) ) {
			...
			if( method_exists( $wpml_post_translations, 'get_element_lang_code' ) ) {
				$language_code = $wpml_post_translations->get_element_lang_code( $product_id );
			}
		}
...
function wcfm_get_option( $key, $default_val = '', $lang_code = '' ) {
	...
	if ( defined( 'ICL_SITEPRESS_VERSION' ) && ! ICL_PLUGIN_INACTIVE && class_exists( 'SitePress' ) ) {
		...
		$current_val = get_option( $key . '_' . $current_language );

		if( $current_val ) {
			$wpml_option_val = $current_val;
		} else {
			if( apply_filters( 'wcfm_use_default_language_if_current_language_value_not_found', true, 'option' ) ) {
				$default_language = $sitepress->get_default_language();
				$default_val = get_option( $key . '_' . $default_language );

				if( $default_val ) {
					$wpml_option_val = $default_val;
				}
			}
		}

		if( $wpml_option_val || apply_filters( 'wcfm_skip_meta_before_wpml', false, 'option' ) ) {
			return $wpml_option_val;
		}
	}
...
function wcfm_get_post_meta( $post_id, $key, $is_single = true ) {
	...
	if ( defined( 'ICL_SITEPRESS_VERSION' ) && ! ICL_PLUGIN_INACTIVE && class_exists( 'SitePress' ) ) {
		...
		$current_language = $sitepress->get_current_language();
		$current_val = get_post_meta( $post_id, $key . '_' . $current_language, $is_single );

		if( $current_val ) {
			$wpml_meta_val = $current_val;
		} else {
			if( apply_filters( 'wcfm_use_default_language_if_current_language_value_not_found', true, 'postmeta' ) ) {
				$default_language = $sitepress->get_default_language();
				$default_val = get_post_meta( $post_id, $key . '_' . $default_language, $is_single );

				if( $default_val ) {
					$wpml_meta_val = $default_val;
				}
			}
		}

		if( $wpml_meta_val || apply_filters( 'wcfm_skip_meta_before_wpml', false, 'postmeta' ) ) {
			return $wpml_meta_val;
		}
	}
...
function wcfm_get_user_meta( $user_id, $key, $is_single = true ) {
	...
	if ( defined( 'ICL_SITEPRESS_VERSION' ) && ! ICL_PLUGIN_INACTIVE && class_exists( 'SitePress' ) ) {
		...
		$current_language = $sitepress->get_current_language();
		$current_val = get_user_meta( $user_id, $key . '_' . $current_language, $is_single );

		if( $current_val ) {
			$wpml_meta_val = $current_val;
		} else {
			if( apply_filters( 'wcfm_use_default_language_if_current_language_value_not_found', true, 'usermeta' ) ) {
				$default_language = $sitepress->get_default_language();
				$default_val = get_user_meta( $user_id, $key . '_' . $default_language, $is_single );
		...
		if( $wpml_meta_val || apply_filters( 'wcfm_skip_meta_before_wpml', false, 'usermeta' ) ) {
			return $wpml_meta_val;
		}
	}
