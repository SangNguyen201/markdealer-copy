<?php
	...
	*/
	...
	function dnd_upload_cf7_tag_generator_file( $contact_form, $args = '' ) {
		...
		$description = __( "Generate a form-tag for a file uploading field. For more details, see %s.", 'drag-and-drop-multiple-file-upload-contact-form-7' );
		$desc_link = wpcf7_link( __( 'https://contactform7.com/file-uploading-and-attachment/', 'drag-and-drop-multiple-file-upload-contact-form-7' ), __( 'File Uploading and Attachment', 'drag-and-drop-multiple-file-upload-contact-form-7' ) );
		...
		<div class="control-box">
			<fieldset>
				...
				<table class="form-table">
					<tbody>
						<tr>
							<th scope="row"><?php echo esc_html( __( 'Field type', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></th>
							<td>
								<fieldset>
									<legend class="screen-reader-text"><?php echo esc_html( __( 'Field type', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></legend>
									<label><input type="checkbox" name="required" /> <?php echo esc_html( __( 'Required field', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label>
								</fieldset>
							</td>
						</tr>
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-name' ); ?>"><?php echo esc_html( __( 'Name', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
							<td><input type="text" name="name" class="tg-name oneline" id="<?php echo esc_attr( $args['content'] . '-name' ); ?>" /></td>
						</tr>
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-limit' ); ?>"><?php echo esc_html( __( "File size limit (bytes)", 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
							<td><input type="text" name="limit" class="filesize oneline option" id="<?php echo esc_attr( $args['content'] . '-limit' ); ?>" /></td>
						</tr>
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-filetypes' ); ?>"><?php echo esc_html( __( 'Acceptable file types', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
                        ...
                        <tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-blacklist-types' ); ?>"><?php echo esc_html( __( 'Blacklist file types', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
						...
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-min-file' ); ?>"><?php echo esc_html( __( 'Minimum file upload', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
						...
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-max-file' ); ?>"><?php echo esc_html( __( 'Max file upload', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
						...
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-id' ); ?>"><?php echo esc_html( __( 'Id attribute', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
							<td><input type="text" name="id" class="idvalue oneline option" id="<?php echo esc_attr( $args['content'] . '-id' ); ?>" /></td>
						</tr>
						<tr>
							<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-class' ); ?>"><?php echo esc_html( __( 'Class attribute', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?></label></th>
		...
		<div class="insert-box">
			...
			<div class="submitbox">
				<input type="button" class="button button-primary insert-tag" value="<?php echo esc_attr( __( 'Insert Tag', 'drag-and-drop-multiple-file-upload-contact-form-7' ) ); ?>" />
			</div>
			<br class="clear" />
			<p class="description mail-tag">
				<label for="<?php echo esc_attr( $args['content'] . '-mailtag' ); ?>"><?php echo sprintf( esc_html( __( "To attach the file uploaded through this field to mail, you need to insert the corresponding mail-tag (%s) into the File Attachments field on the Mail tab.", 'drag-and-drop-multiple-file-upload-contact-form-7' ) ), '<strong><span class="mail-tag"></span></strong>' ); ?><input type="text" class="mail-tag code hidden" readonly="readonly" id="<?php echo esc_attr( $args['content'] . '-mailtag' ); ?>" /></label>
			</p>
		</div>
		...
		echo '<div class="wrap">';
			echo '<h1>' . esc_html__( 'Drag & Drop Uploader - Settings', 'drag-and-drop-multiple-file-upload-contact-form-7' ) . '</h1>';
				...
				echo '<div class="update-nag notice" style="width: 98%;padding: 0px 10px;margin-bottom: 5px;">';
					echo '<p>' . sprintf(esc_html__( 'Checkout more features on %1$sPro Version%2$s', 'drag-and-drop-multiple-file-upload-contact-form-7' ),'<a href="https://codedropz.com/purchase-plugin/" target="_blank">','</a>') . '</p>';
				echo '</div>';
		...
		?>
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td><input type="text" name="drag_n_drop_text" class="regular-text" value="<?php echo esc_attr( get_option('drag_n_drop_text') ); ?>" placeholder="<?php esc_attr_e( 'Drag & Drop Files Here', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?>" /></td>
					</tr>
					<tr valign="top">
						<th scope="row"></th>
						<td><input type="text" name="drag_n_drop_separator" value="<?php echo esc_attr( get_option('drag_n_drop_separator') ); ?>" placeholder="<?php esc_attr_e( 'or', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?>" /></td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php _e('Browse Text','drag-and-drop-multiple-file-upload-contact-form-7'); ?></th>
						<td><input type="text" name="drag_n_drop_browse_text" class="regular-text" value="<?php echo esc_attr( get_option('drag_n_drop_browse_text') ); ?>" placeholder="<?php esc_attr_e( 'Browse Files', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?>" /></td>
					</tr>
				</table>
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td><input type="text" name="drag_n_drop_error_max_file" class="regular-text" value="<?php echo esc_attr( get_option('drag_n_drop_error_max_file') ); ?>" placeholder="" /><p class="description"><?php esc_html_e( 'Example: `Note : Some of the files are not uploaded ( Only %count% files allowed )`', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?></p></td>
					</tr>
					<tr valign="top">
				...
				<table class="form-table">
					<tr valign="top">
						...
						<td><input type="checkbox" name="drag_n_drop_disable_auto_delete" value="yes" <?php checked('yes', get_option('drag_n_drop_disable_auto_delete')); ?>><?php esc_html_e( ' Yes ', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?><br><p class="description"><em><?php esc_html_e( 'The default will automatically delete files 1-2 hours after submissions, if you want to keep files check "Yes" above.', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?></em></p></td>
					</tr>
				</table>
				...
				<table class="form-table">
					<tr valign="top">
						...
						<td><input type="checkbox" name="drag_n_drop_fix_spam" value="yes" <?php checked('yes', get_option('drag_n_drop_fix_spam')); ?>><?php esc_html_e( ' Yes ', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?><p class="description"><em><?php esc_html_e( 'If a “spam” answer is the response, Contact Form 7 will suspend the email and show a message saying, “There was an error trying to send your message", force to send message by checking this option.', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?></em></p></td>
					</tr>
				</table>
				...
				<table class="form-table">
					<tr valign="top">
						...
						<td><input type="checkbox" name="drag_n_drop_use_jquery" value="yes" <?php checked('yes', get_option('drag_n_drop_use_jquery')); ?>><?php esc_html_e( ' Yes ', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?><p class="description"><em><?php esc_html_e( 'Activate this option in case there are any problems with our plugin when utilizing native Javascript.', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?></em></p></td>
					</tr>
				</table>
				...
				<table style="display:none;" class="form-table">
					<tr valign="top">
						...
						<td><input type="checkbox" name="drag_n_drop_disable_btn" value="yes" <?php checked('yes', get_option('drag_n_drop_disable_btn')); ?>><?php esc_html_e( ' Yes ', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?><p class="description"><?php esc_html_e( 'Disable submit button if there\'s an error.', 'drag-and-drop-multiple-file-upload-contact-form-7' ); ?></p></td>
					</tr>
				</table>
	...
	function dnd_custom_plugin_row_meta( $links, $file ) {
		if ( strpos( $file, 'drag-n-drop-upload-cf7.php' ) !== false ) {
			$new_links = array('pro-version' => '<a href="https://codedropz.com/purchase-plugin/" target="_blank" style="font-weight:bold; color:#f4a647;">' . esc_html__( 'Pro Version', 'drag-and-drop-multiple-file-upload-contact-form-7' ) . '</a>');
